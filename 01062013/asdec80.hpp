// ---------------------------------------------------
// asdec80.hpp  25-Feb-11   Running on Mac OS X 10.6.6
...
static char szAsdec80Hpp[] = "$Id: asdec80.hpp,v 1.1 2011/03/24 11:58:05 doug Exp $";

void decode_8080(void)
{
	int rc;
	unsigned int value;
