# ---------------------------------------------------
# mkfiles/forth_original.mak  Ver 11.03.13d  
# Serial No. 2011-1042-654321    All Rights Reserved.
# Copyright (C) 2011 Douglas Goodall,  United States.
# ---------------------------------------------------
# mkfiles/forth_original.mak autogenerated by asmall.cpp 
...
forth_original.hex:	forth_original.asm $(INCFILES) $(AS) 
	$(AS) forth_original 

clean:
	rm -f *.bin  *.lst *.log *.hex

# eof - mkfiles/forth_original.mak
