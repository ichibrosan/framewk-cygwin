// ---------------------------------------------------
// asdecz80.hpp 25-Feb-11   Running on Mac OS X 10.6.6
...
static char szAsdecz80Hpp[] = "$Id: asdecz80.hpp,v 1.1 2011/03/24 11:58:05 doug Exp $";

void decode_Z80(void)
{
	int rc;
	unsigned int value;
