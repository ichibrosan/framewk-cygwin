// ---------------------------------------------------
// asdec20.hpp  25-Feb-11   Running on Mac OS X 10.6.6
...
static char szAsdec20Hpp[] = "$Id: asdec20.hpp,v 1.1 2011/03/25 05:49:38 doug Exp $";

void decode_1620(void)
{
	int rc;
	unsigned int value;
