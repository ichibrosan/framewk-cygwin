// ---------------------------------------------------
// deco8085.hpp 25-Feb-11   Running on Mac OS X 10.6.6
...
static char szAsdec85Hpp[] = "$Id: asdec85.hpp,v 1.1 2011/03/24 11:58:05 doug Exp $";

void decode_8085(void)
{
	int rc;
	unsigned int value;
