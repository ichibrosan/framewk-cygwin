# ---------------------------------------------------
# mkfiles/testdefs.mak  Ver 11.03.24c  
# Serial No. 2011-1042-654321    All Rights Reserved.
# Copyright (C) 2011 Douglas Goodall,  United States.
# ---------------------------------------------------
# mkfiles/testdefs.mak autogenerated by asmall.cpp 
# Thu Mar 24 02:27:55 PDT 2011
...
testdefs.hex:	testdefs.asm $(INCFILES) $(AS) 
	$(AS) testdefs 

clean:
	rm -f *.bin  *.lst *.log *.hex

# eof - mkfiles/testdefs.mak
